...
ADual_Buckshot::ADual_Buckshot()
{

}

void ADual_Buckshot::BeginPlay()
{
	Super::BeginPlay();
	
}
void ADual_Buckshot::ActionPlayEffect(UWorld* Inworld, ACharacter* InOwner)
{
...
void ADual_Buckshot::ActionPlayEffect(USkeletalMeshComponent* mesh, FName InSocketName)
{
	if (!ActionEffect) return;
...
void ADual_Buckshot::HitPlayEffect(UWorld* Inworld, ACharacter* InOwner)
{
	if (!HitEffect) return;
...
void ADual_Buckshot::HitPlayEffect(USkeletalMeshComponent* mesh, FName InSocketName)
{
	if (!HitEffect) return;
