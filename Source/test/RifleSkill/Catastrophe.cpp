...
ACatastrophe::ACatastrophe()
{

}

void ACatastrophe::BeginPlay()
{
	Super::BeginPlay();
	
}

void ACatastrophe::ActionPlayEffect(UWorld* Inworld, ACharacter* InOwner)
{
...
void ACatastrophe::ActionPlayEffect(USkeletalMeshComponent* mesh, FName InSocketName)
{
	if (!ActionEffect) return;
...
void ACatastrophe::HitPlayEffect(UWorld* Inworld, ACharacter* InOwner)
{
	if (!HitEffect) return;
...
void ACatastrophe::HitPlayEffect(USkeletalMeshComponent* mesh, FName InSocketName)
{
	if (!HitEffect) return;
