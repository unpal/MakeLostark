...
ALast_Request::ALast_Request()
{

}

void ALast_Request::BeginPlay()
{
	Super::BeginPlay();
	
}
void ALast_Request::ActionPlayEffect(UWorld* Inworld, ACharacter* InOwner)
{
...
void ALast_Request::ActionPlayEffect(USkeletalMeshComponent* mesh, FName InSocketName)
{
	if (!ActionEffect) return;
...
void ALast_Request::HitPlayEffect(UWorld* Inworld, ACharacter* InOwner)
{
	if (!HitEffect) return;
...
void ALast_Request::HitPlayEffect(USkeletalMeshComponent* mesh, FName InSocketName)
{
	if (!HitEffect) return;
